...
class MenuUsuario:
                ...
                while True:
                    if opcion == 's':
                        ...
                        if volverACargar == 'a':
                            ...
                            return tester.MenuGeneral.main(self)
                    elif opcion == 'n':
    ...
    def conectarse(self):
        ...
        usu = input(f'{Fore.YELLOW}Nombre Usuario: {Fore.RESET}')
        psw = input(f'{Fore.YELLOW}Password: {Fore.RESET}')
        for usuarioActual in dataUsuario['usuarios']:
            if usuarioActual['nombre_usuario'] == usu and usuarioActual['password'] == psw:
                return tester.MenuGeneral.menuPrincipal(self, usuarioActual)
